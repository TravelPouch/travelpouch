      ...
      item {
        Column(
          ...
          Row(Modifier.padding(10.dp).align(Alignment.End)) {
            Card(onClick = {}) {
              Row(modifier = Modifier.padding(8f.dp)) { Text("Storage limit: 300 MiB") }
            }
          }
          ...
          Row(modifier = Modifier.fillMaxWidth(0.6f).align(Alignment.CenterHorizontally)) {
            Box(modifier = Modifier.weight(10f)) {
              ...
              Column(modifier = Modifier.align(Alignment.Center)) {
                ...
                Text("284 MiB available", fontSize = 4.em, textAlign = TextAlign.Center)
              }
            }
          }
...
fun CircularStorageDiagram(
  ...
  LaunchedEffect(Unit) { loadingValue.animateTo(1f, tween(1500, 0, FastOutSlowInEasing)) }
