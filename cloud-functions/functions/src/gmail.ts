...
/** Process the new messages id into the new attachments
 * @param {string[]} newMessagesId the id of the new messages
 * @param {string} accessToken the access token to connect to the gmail api
 * @return {Promise<void>} a promise
 * */
export async function processNewMessagesId(newMessagesId: string[],
  accessToken: string) {
